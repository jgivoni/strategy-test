...
sim_post_gaussian<-function (sum.revenues,sum.squared.revenues, n, mu0=0,nu0=0,alpha0 = 0, beta0 = 0, ndraws = 5000) {
...
best_gaussian_bandit_sim<-function (sum.revenues,sum.squared.revenues, n, mu0=0,nu0=0,alpha0 = 0, beta0 = 0, ndraws = 5000) {
...
bandit <- function(visits, conversions, revenue, stdev, revPerConvStdev) {
    sum_sq_rev = visits*stdev^2
    
    weights <- best_gaussian_bandit_sim(revenue, sum_sq_rev, visits)
